...
También se utiliza la inyección de prompt por multipasos, donde en lugar de usar un solo *prompt*, se envían varios. O bien la extracción de datos, en la que se fuerza a revelar información sensible.
